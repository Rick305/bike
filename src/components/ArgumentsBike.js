...
function ArgumentsBike({distance, calories, money, co2}) {
    ...
    return (
        <div className="text-2xl">
            <h1 className="h1-results text-center text-6xl leading-normal">{t('title')}</h1>
            ...
            <Trans i18nKey="text" >
                ...
                <Orange string={`${calories} calories`}>{{calories}}</Orange>. And because you bikes dont have polution 
